<template>
	<div @click="onFieldClick" class="edit-cell">
		...
		<component :is="editableComponent" v-if="editMode || showInput" size="mini" ref="input" @focus="onFieldClick" @keyup.enter.native="onInputExit" v-on="listeners" v-bind="$attrs" v-model="model">
