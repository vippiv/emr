<template>
    <div class="subTplmanage-wordEdit">
        <el-dialog title="子模板维护" :visible.sync="dialogSortVisible" width="100%" fullscreen :before-close="handleClose" append-to-body :close-on-click-modal="false">
            <div style="display:flex; height: calc(100vh - 100px); overflow: hidden;">
                <div class="leftTree" style="flex:0 0 300px;">
                    <el-row  style="margin-bottom:6px;border:1px solid #EBEEF5;height:52px;line-height:3.8;padding:auto 5px;">
                        <el-col :span="7" style="text-align:right;">子模板名称：</el-col>
                        <el-col :span="16">
...
<script>
    ...
    import activeXHandlerTempl from '@/views/residentDoctor/respiratory/components/activeXHandlerTempl'
    import handleActiveX from '@/utils/activeX'
    import moment from 'moment'
    export default {
        name: 'subTplManageSonWordEdit',
        components: {
            activeXHandlerTempl
        },
        props: {
